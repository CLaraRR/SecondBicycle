...
<table width="95%" height="125" border="1">
 ...
 %>                       
  <tr>
      <td align="center"><%=newOrder.getOrderid()%></td>
      <td align="center"><%=newOrder.getUsername()%></td>
      <td align="center"><%=newOrder.getOther()%></td>
      <td align="center"><%=newOrder.getProductid()%></td>
	  <td align="center"><%=newOrder.getBrand()%></td>
      <td align="center"><%=newOrder.getType()%></td>
      <td align="center"><%=newOrder.getNum()%></td>
      <td align="center"><%=newOrder.getPrice()%></td>
      <td align="center"><%=newOrder.getTotalprice()%></td>
