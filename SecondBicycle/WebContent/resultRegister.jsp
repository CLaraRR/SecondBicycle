	...
	<div class="header-bottom">
     ...
     <div class="clear"></div>
        ...
        <div class="login">
					...
					<h1 align="center" style="font-size:30px;">Register Information</h1>
                     <p style="text-align:center;"><br><br><br>
                     <%
                        User newRegister=(User)request.getAttribute("register");
                        out.print("用户名："+newRegister.getUsername()+"<br>");
                        out.print("密码："+newRegister.getPassword()+"<br>");
                        out.print("手机号码："+newRegister.getPhone()+"<br>");
                        out.print("邮箱："+newRegister.getEmail()+"<br>");
                        out.print("地址："+newRegister.getAddress()+"<br>");
                        
                        HttpSession session=request.getSession();
                        session.setAttribute("user", newRegister.getUsername());
                        out.print("<a href='index.jsp'>跳转到首页<a>");
                   %>
                  </p>
					</div><br><br><br><br>
