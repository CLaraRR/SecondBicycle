	...
	<div class="header-bottom">
     ...
     <div class="clear"></div>
        ...
        <div class="login">
					...
					<h1 align="center" style="font-size:30px;">Product Information</h1>
                        <p style="text-align:center;">
                        <%

                                 Product newProduct=(Product)request.getAttribute("publish");
                                 out.print("商品ID："+newProduct.getProductid()+"<br>");
                                 out.print("品牌："+newProduct.getBrand()+"<br>");
                                 out.print("类型："+newProduct.getType()+"<br>");
                                 out.print("单价："+newProduct.getPrice()+"<br>");
                                 out.print("联系电话："+newProduct.getPhone()+"<br>");
                                 out.print("其他描述："+newProduct.getOther()+"<br>");
