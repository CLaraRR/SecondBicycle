		...
		<div class="cont span_2_of_3">
		  	<div class="grid images_3_of_2">
							...
							<div id="products_example">
								<div id="products">
									<div class="slides_container">
									        <a href="#"><img style="width:295px;height:295px;"class="a" id="img4" src="images/img4.jpg" alt="" rel="images/img1.jpg" /></a>
											
									</div>
									<ul class="pagination">
										<li><a href="#"><img src="images/img4.jpg" width="s-img" alt="1144953 3 2x"></a></li>
		         ...
		         <div class="desc1 span_3_of_2">
		         	<h3 class="m_3" >组装捷安特山地车自行车 铝合金车架ATX777油刹27变速山地自行车</h3>
		             <p class="m_5">八成新359 <span class="reducedfrom">原价599</span> <a href="#">click for offer</a></p>
		         	 <div class="btn_form">
						<form>
					...
					<span class="m_link"><a href="#">登陆就可以收藏哟~</a> </span>
				     <p class="m_text2"><pre>
产品参数：
品牌: Giant/捷安特   车架材质: 铝合金    轮径尺寸: 24英寸 26英寸
颜色分类: 21速标配经济版【高碳钢】 21速高配豪华版【高碳钢】 
速别: 21速 24速      货号: ATXpro       尺寸: 26英寸x17英寸
制动系统: 双碟刹     车架类型: 硬车架
前叉类型: 弹簧叉(低档无阻尼)</pre> </p>
			     </div>
			   <div class="clear"></div>	
	    <div class="clients">
	...
	<script type="text/javascript" src="js/jquery.flexisel.js"></script>
     ...
     <div class="toogle">
        ...
        <img src="images/pro_des40.jpg"><img>
        <img src="images/pro_des41.jpg"><img>
        <img src="images/pro_des42.jpg"><img>
        <img src="images/pro_des43.jpg"><img>
     ...
     <div class="toogle">
        ...
        <img src="images/know_more40.jpg"><img>
        <img src="images/know_more41.jpg"><img>
