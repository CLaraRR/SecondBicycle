        ...
        <div class="login">
          	<div class="wrap">
				...
				<div class="login-title">
	           		<h4 class="title">说出你想卖的车~</h4>
					<div id="loginbox" class="loginbox">
						<form action="Publish.do" method="POST" name="login" id="login-form">
						  <fieldset class="input">
						    <p id="login-form-brand">
						      <label for="modlgn_brand">品牌</label><br>
						        <select name="Brand" size="1" style="width:100%;height:25px;">
                                    <option value="捷安特">捷安特</option>
                                    <option value="欧拜克">欧拜克</option>
                                    <option value="宝马">宝马</option>   
                                    <option value="凤凰">凤凰</option>
                                    <option value="永久">永久</option>
                                    <option value="美利达">美利达</option>
                                    <option value="大行">大行</option>
                                    <option value="奥迪">奥迪</option>
                                    <option value="喜德盛">喜德盛</option>
                                    <option value="飞鸽">飞鸽</option>
                                 </select>
						    </p>
						    <p id="login-form-type">
						      <label for="modlgn_type">类型</label><br>
						        <select name="Type" size="1" style="width:100%;height:25px;">
                                    <option value="山地车">山地车</option>
                                    <option value="公路车">公路车</option>
                                    <option value="折叠车">折叠车</option>   
                                    <option value="折叠车">迷你车</option>
                                    <option value="学生车">学生车</option>
                                    <option value="死飞">死飞</option>
                                    <option value="休闲车">休闲车</option>
                             ...
                             <p id="login-form-username">
						      <label for="modlgn_username">价格</label> 
						      <input id="modlgn_username" type="text" name="Price" class="inputbox" size="18" autocomplete="off">
						    
						    </p>
                             <p id="login-form-username">
						      <label for="modlgn_username">联系电话</label> 
						      <input id="modlgn_username" type="text" name="Phone" class="inputbox" size="18" autocomplete="off">
						    </p>
                             <p id="login-form-username">
						      <label for="modlgn_username">其他描述</label> 
						     
						      <textarea rows="10" cols="70" name="Other"></textarea>

						    </p>
						    <div class="remember">
							    
							    <input type="submit" name="Publish" class="button" value="发布"><div class="clear"></div>
							 </div>
						  </fieldset>
						 </form>
					</div>
